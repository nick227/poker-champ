...
export const LAYOUT_TITLE_HEIGHT = 55;
export const LAYOUT_TOP_BAR_HEIGHT = 52;
export const GAME_AREA_HEIGHT = 244;
export const OPPONENT_STRIP_HEIGHT = 225;
...
export const TABLE_SHELL_TOP_BAR_CLASSNAME = "border-t border-b border-border-subtle";
