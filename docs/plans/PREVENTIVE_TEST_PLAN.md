...
| T07 | Lobby sync | Ensure multi-user lobby sees active tables immediately | Manual + `docs/status/PHASE5_TWO_BROWSER_RELEASE_GATE_LOG.md` | Release owner | Pre-release | Required |
| T08 | Two-browser release E2E | Human correctness of turn prompts/actions/payouts | Manual checklist in `docs/status/PHASE5_TWO_BROWSER_RELEASE_GATE_LOG.md` | Release owner | Pre-release | Required |
...
- `docs/status/PHASE5_TWO_BROWSER_RELEASE_GATE_LOG.md`
4. Mark final result PASS/FAIL with notes and follow-up issues.

## Failure Handling Policy
- Any failure in required gates blocks release.
- Log failures in `docs/status/PHASE5_TWO_BROWSER_RELEASE_GATE_LOG.md`.
