...
- Disconnect/reconnect flow: `src/rooms/PokerRoom.ts` (`onLeave`, `markDisconnectedSafe`, `markReconnectedSafe`), `docs/PLAYER_JOIN_LEAVE_DISCONNECT_DEEP_DIVE.md`.
...
- Delete: `LobbyRouter` DELETE handler, `GameTableRow` canDelete, `docs/GAME_DELETE_BUTTON_ANALYSIS.md`.
