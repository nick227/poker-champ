export const openApiSpec = {
    ...
    schemas: {
      ...
      TournamentSummary: {
        ...
        properties: {
          ...
          lateRegClosesAt: { type: "string", format: "date-time" },
      ...
      TournamentEnsureTableResult: {
        ...
        properties: {
          ...
          playerStatus: {
            type: "string",
            enum: ["ACTIVE", "ELIMINATED", "NOT_REGISTERED"],
          },
          tableId: { type: "string", nullable: true },
          roomId: { type: "string", nullable: true },
          tableLive: { type: "boolean" },
          joinStatus: {
            type: "string",
            enum: ["READY", "RESTORED", "CREATING_TABLE", "ENDED", "NOT_ALLOWED", "FAILED"],
          },
      ...
      CashTableResumeResult: {
        ...
        properties: {
          ...
          resumeStatus: {
            type: "string",
            enum: ["READY", "ROOM_RECOVERED", "NEEDS_BUY_IN", "NOT_SEATED", "ENDED", "FAILED"],
          },
          playerStatus: {
            type: "string",
            enum: ["SEATED", "NOT_SEATED"],
          },
          seatSessionState: {
            type: "string",
            nullable: true,
            enum: ["SEATED_ACTIVE", "SEATED_SITTING_OUT", "LEFT"],
          },
          stackCentsSnapshot: { type: "integer", nullable: true },
          minBuyInCents: { type: "integer" },
          maxBuyInCents: { type: "integer" },
          recoveryReason: { type: "string" },
        },
        required: ["tableId", "roomId", "tableLive", "resumeStatus", "playerStatus"],
      },
      LobbyTableSummary: {
        type: "object",
        properties: {
  ...
  paths: {
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  ...
                  blindStructureId: {
                    type: "string",
                    enum: ["fast_4min", "standard_8min", "long_12min"],
                  },
                  lateRegMinutes: { type: "integer", minimum: 0, maximum: 120 },
                  fillBotsAtStart: { type: "boolean" },
                  fillBotCount: { type: "integer", minimum: 1, maximum: 8 },
                  playFormat: { type: "string", enum: ["FREEZEOUT", "REBUY"] },
                  maxRebuysPerPlayer: { type: "integer", minimum: 0, maximum: 10 },
                  rebuyPeriodMinutes: { type: "integer", minimum: 0, maximum: 120 },
                  instantStart: { type: "boolean" },
                },
                  ...
                  properties: {
                    standings: {
                      ...
                      items: {
                        ...
                        required: ["userId", "displayName", "finishPlace", "eliminatedAt", "payoutCents", "isBot"],
                      },
                    },
                  },
                  required: ["standings"],
    ...
    "/api/tournaments/{id}/ensure-table": {
      post: {
        tags: ["tournaments"],
        operationId: "tournamentsEnsureTable",
        security: [{ bearerAuth: [] }],
        parameters: [{ name: "id", in: "path", required: true, schema: { type: "string" } }],
        responses: {
          "200": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/TournamentEnsureTableResult" },
              },
            },
          },
          "400": {
    ...
    "/api/tables/{tableId}/resume": {
      post: {
        ...
        requestBody: {
          ...
          content: {
            "application/json": {
              schema: { $ref: "#/components/schemas/CashTableResumeRequest" },
            },
          },
        },
        responses: {
          "200": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/CashTableResumeResult" },
              },
            },
          },
          "400": {
